...
class Songplayer    //class declaration.
{
    public:
            ...
            void sort1();           //sort
            void display();         //display the play list.
            void reverse();         //reverse the play list.
            void play_start();      //play the first song.
            void play_last();       //play the last song
            void search_song();     //play the searched song.
};
//main function
int main()

{
...

    {
        ...
        cout<<"10.Play the first song"<<endl;

        cout<<"11.Play the last song "<<endl;

        cout<<"12.Play the searched song "<<endl;
...
void Songplayer::del_search()                                       //to search for a song and delete it.
{
    int pos = 0, i;
    bool flag = false;
    struct song *s;
...
void Songplayer::sort1()                                                //sort the playlist according to name.
{
    struct song *temp, *s;
    int i;
    string str;
...
void Songplayer::play_start()
{
    struct song *s;
     string song2 = start->name;
    cout<<song2<<endl;
    ...
    strcpy(char_array, song2.c_str());


  char str2[80];
  strcpy (str2,char_array);
  strcat (str2,".wav ");

PlaySound(TEXT(str2),NULL,SND_SYNC);
...
void Songplayer::play_last()
{
    struct song *s;
     string song2 = last->name;
    cout<<song2<<endl;
...
void Songplayer::search_song()                                       //to search for a song.
{
    int pos = 0, i;
    bool flag = false;
    struct song *s;
    ...
    if (start == last && start == NULL)
    {
        cout<<" the play list is not created"<<endl;
        return;

    }
    cout<<endl<<"Enter the song name to be played: ";
        cin>>sname;
